package ex28_testNG.TNG17_listenersVVI;
...
public class TNG18A_listeners implements ITestListener {
    ...
    // Following listeners are available in testNG: - IAnnotationTransformer, IAnnotationTransformer2, IHookable, IInvokedMethodListener, IMethodInterceptor, IReporter, ISuiteListener, ITestListener etc.
    /* Difference between listeners and annotations:
        1. annotations are limited and they are very clear as funtionality wise.
